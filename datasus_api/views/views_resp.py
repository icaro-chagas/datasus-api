...
@swagger_auto_schema(
    ...
    manual_parameters=[uf_param_get, year_param_get, page_number_get], responses={200: 'OK'}, tags=['RESP']
)
@swagger_auto_schema(
    ...
    manual_parameters=[uf_param_post, year_param_post], responses={201: 'Created', 400: 'Bad Request'}, tags=['RESP']
)
@swagger_auto_schema(
    ...
    manual_parameters=[uf_param_delete, year_param_delete], tags=['RESP'], responses={204: 'No Content', 400: 'Bad Request'}
)
