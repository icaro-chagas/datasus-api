...
from ..serializers.serializers_siscolo import CCSerializer, HCSerializer
...
@swagger_auto_schema(
    ...
    manual_parameters=[uf_param_post, month_param_post, year_param_post], responses={201: 'Created', 400: 'Bad Request'}, tags=['SISCOLO/CC']
)
@swagger_auto_schema(
    methods=['DELETE'], operation_summary='Deleta dados do CC', operation_description='Deleta dados de acordo com os parâmetros informados.',
    manual_parameters=[uf_param_delete, month_param_delete, year_param_delete], tags=['SISCOLO/CC'], responses={204: 'No Content', 400: 'Bad Request'}
)
@api_view(['GET', 'POST', 'DELETE'])
def handle_request_cc(request, format='json'):
    return handle_request(request, 'CC')
...
@swagger_auto_schema(
    ...
    manual_parameters=[uf_param_post, month_param_post, year_param_post], responses={201: 'Created', 400: 'Bad Request'}, tags=['SISCOLO/HC']
)
@swagger_auto_schema(
    methods=['DELETE'], operation_summary='Deleta dados do HC', operation_description='Deleta dados de acordo com os parâmetros informados.',
    manual_parameters=[uf_param_delete, month_param_delete, year_param_delete], tags=['SISCOLO/HC'], responses={204: 'No Content', 400: 'Bad Request'}
)
@api_view(['GET', 'POST', 'DELETE'])
def handle_request_hc(request, format='json'):
    return handle_request(request, 'HC')
