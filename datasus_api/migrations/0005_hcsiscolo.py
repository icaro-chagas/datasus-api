# Generated by Django 4.2.10 on 2024-05-02 03:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'db_table': 'hc_siscolo',
                'indexes': [models.Index(fields=['uf', 'ano', 'mes'], name='hc_siscolo_uf_6b2ecf_idx'), models.Index(fields=['uf', 'ano'], name='hc_siscolo_uf_da80c0_idx'), models.Index(fields=['uf', 'mes'], name='hc_siscolo_uf_723365_idx'), models.Index(fields=['mes', 'ano'], name='hc_siscolo_mes_110fec_idx')],
            },
        ),
    ]
